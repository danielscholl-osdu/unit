...
import org.opengroup.osdu.unitservice.v2.model.ABCDImpl;
...
public class UnitRequest {
	...
	public UnitEssenceImpl getUnitEssence() {
		if (this.unitEssence == null) {
			try {
				this.unitEssence = org.opengroup.osdu.unitservice.v2.helper.Utility.fromJsonString(this.persistableReference, UnitEssenceImpl.class);
