#This test file is the same as test_unit_service_v3.py in unit_test_core except the invalid JWT tests are changed slight to 
# accomodate the different response body that azure AppGateway returns for unauthorized users
import sys
sys.path.append("..")

#import statement that used to bring code from unit_test_core
#from unit_test_core.test_unit_service_v3 import *

#Everything after this line is the custom version of "run_test_api_v3.py" from unit_test_core
# coding: utf-8
...
#End of the custom "run_test_api_v3.py" code
