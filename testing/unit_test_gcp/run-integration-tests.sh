...
then
    echo "Missing argument INTEGRATION_TESTER. It is generated by Googld Cloud for the integration tester service account."
    exit 1
fi

KEY=${1:-$INTEGRATION_TESTER}
...
export INTEGRATION_TESTER=${KEY}
export GOOGLE_AUDIENCES=$2
# Run tests
